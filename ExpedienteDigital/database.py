...
class InsertarBaseDatos:
    ...
    def insertar_datos_iniciales(self):
        try:
            ...
            self.cursor.execute('''
                INSERT INTO expedientes (id_mascota, nombre, especie, raza, edad, alergias, padecimientos, historial) VALUES 
                (?, ?, ?, ?, ?, ?, ?, ?)
            ''', (id_mascota, 'Bobby', 'Perro', 'Labrador', 5, 'Alergia por Pulgas', 'Pulgoso', 'Sin citas Previas'))
