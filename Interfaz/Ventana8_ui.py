...
"")
        ...
        self.push_Button_BuscarMascota = QPushButton(self.centralwidget)
        self.push_Button_BuscarMascota.setObjectName(u"push_Button_BuscarMascota")
        self.push_Button_BuscarMascota.setGeometry(QRect(680, 150, 261, 51))
        self.push_Button_BuscarMascota.setStyleSheet(u"font: 16pt \"MS Shell Dlg 2\";")
        self.mdiArea_8 = QMdiArea(self.centralwidget)
        self.mdiArea_8.setObjectName(u"mdiArea_8")
        self.mdiArea_8.setGeometry(QRect(650, 140, 311, 71))
        ...
        self.label_2.raise_()
        self.push_Button_BuscarMascota.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.push_Button_BuscarMascota.setText(QCoreApplication.translate("MainWindow", u"Buscar Mascota", None))
    # retranslateUi
