...
################################################################################
## Form generated from reading UI file 'NewExpediente.ui'
##
...
"}")
        ...
        self.centralwidget.setGeometry(QRect(-10, 20, 1301, 881))
...
"font: 16pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, ExpedienteDialog):
        ...
        self.pushButton.setText(QCoreApplication.translate("ExpedienteDialog", u"Crear Expediente", None))
        ...
        self.pushButtonMostrarDatos.setText(QCoreApplication.translate("ExpedienteDialog", u"Guardar Cambios ", None))
